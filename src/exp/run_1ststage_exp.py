...
import torch
from stage1st_training_loop_earlysave import seed_everything
from stage1st_training_loop_earlysave import stage1st_training_loop_earlysave
...
if __name__ == "__main__":
    ...
    stage1st_training_loop_earlysave(config, logger)
